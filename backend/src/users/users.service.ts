...
export class UsersService {
  ...
  /** `queryable` matters when the user was created in the SAME uncommitted
   *  transaction: read it through the pool and the row is not visible yet. */
  async findById(id: string, queryable: Queryable = this.db): Promise<UserRow | null> {
    const { rows } = await queryable.query<UserRow>(
