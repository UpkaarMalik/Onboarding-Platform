...
export function RingCenter({
  ...
  /* Deviation from the registry source: this was `children && hoveredData`,
     so a custom centre only rendered WHILE a ring was hovered and the
     resting state fell through to the NumberFlow default below. That made a
     hover-aware centre impossible. Now the render prop owns both states. */
  if (children) {
    return (
      <div
        className={cn(
